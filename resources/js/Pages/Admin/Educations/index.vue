    ...
    <section class="educations section" id="educations">
        ...
        >
            <form @submit.prevent="sendForm">
                <div>
                    <p>Institution</p>
                    <input type="text" class="input" v-model="formData.institution" />

                    <p>Period</p>
                    <input type="text" class="input" v-model="formData.period" />

                    <p>Degree</p>
                    <input type="text" class="input" v-model="formData.degree" />

                    <p>Department</p>
                    <input type="text" class="input" v-model="formData.department" />
                </div>
...
const uris = {
    get: "/get_all_education",
    create: "/create_education",
    update: (id) => "/update_education/" + id,
    delete: (id) => "/delete_education/" + id
};
...
const dataContent = [
    { data: "institution", headText: "Institution" },
    { data: "period", headText: "Period" },
    { data: "degree", headText: "Degree" },
    { data: "department", headText: "Department" },
    {
        data: "id",
        headText: "Actions",
